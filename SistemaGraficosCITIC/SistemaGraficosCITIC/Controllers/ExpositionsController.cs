...
namespace SistemaGraficosCITIC.Controllers
{
  public class ExpositionsController : BaseController
  {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit(Guid id, [Bind("Id,Title,Date,Location,Context,Participants,Speaker,ProjectId")] Exposition exposition)
    {
      if (id != exposition.Id)
      {
        return NotFound();
    ...
    {
      return Task.FromResult<IActionResult>(RedirectToAction("Index", "Projects"));
    }
